						  ...
						  <tbody>
							<tr>
                                ...
                                @if($v_manufacture->publication_status==1)
                                    ...
                                    <a class="btn btn-danger" href="{{URL::to('/unactive_manufacture/'.$v_manufacture->id)}}">
										<i class="halflings-icon white thumbs-down"></i>  
                                    </a>
                                @else
                                   
                                    <a class="btn btn-success" href="{{URL::to('/active_manufacture/'.$v_manufacture->id)}}">
